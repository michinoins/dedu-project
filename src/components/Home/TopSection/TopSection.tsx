...
export function TopSection() {
  ...
  return (
    <section className="relative pt-6 pb-24 md:px-0 md:pt-10">
      <div
      ...
      <div className="relative z-10">
        <SectionHeading
          ...
          heading={
            <>
              ...
              <div>
                <Trans>
                  <span style={{ ...rotatedStyle }}>O</span>
                  <span style={{ ...rotatedStyle }}>И</span>{' '}
                  <span style={{ ...rotatedStyle }}>I</span>
                  <span style={{ ...rotatedStyle }}>T</span>
                  <span style={{ ...rotatedStyle }}>S</span>{' '}
                  <span style={{ ...rotatedStyle }}>H</span>
                  <span style={{ ...rotatedStyle }}>E</span>
                  <span style={{ ...rotatedStyle }}>A</span>
                  <span style={{ ...rotatedStyle }}>D</span>
                </Trans>
              </div>
            </>
          }
        ...
        <div className="relative z-10 mt-48 flex flex-col items-center">
          <Image
            ...
            height={50}
          />
          <h2 className="mt-8 text-center text-5xl font-bold text-black">
            <Trans>
